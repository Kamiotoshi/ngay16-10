function displayHeader () {
    ...
    <div class="row header_top">
            <div class="col-4 align-items-center d-flex">
                <nav class="navbar navbar-expand-lg bg-body-tertiary d-lg-none"> <!--phần này hiện khi màn hình bé hơn cỡ lg-->
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                      <span class="fas fa-bars icon-header"></span>
                    </button>
                </nav>

                <!-- phần này bị ẩn khi màn hình bé hơn cỡ lg -->
            ...
            <div class="col-4 align-items-center d-flex justify-content-end">
                ...
                <a href="compare.html"><i class="fa-sharp fa-regular fa-plus"></i></a>
            </div>
        </div>
        <hr class="d-none d-lg-block">
        <!--Hiển thị khi màn hình bé hơn lg và click vào biểu tượng hamburger-->
        ...
        <!--Hiển thị khi màn hình lớn hơn cỡ lg-->
        <div class="row d-none d-lg-block">
            <nav class="nav_list header_bottom col-12 d-flex justify-content-center align-items-center">
                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                    <li class="nav-item header-item" role="presentation"><a class="nav-link" id="v-pills-fridges-tab" data-bs-toggle="pill" data-bs-target="#v-pills-fridges-type" type="button" role="tab" aria-controls="v-pills-fridges-type" aria-selected="true" href="product.html">Fridges</a></li>
                    <li class="nav-item header-item" role="presentation"><a class="nav-link" id="v-pills-laundry-tab" data-bs-toggle="pill" data-bs-target="#v-pills-laundry-type" type="button" role="tab" aria-controls="v-pills-laundry-type" aria-selected="false" href="product.html">Laundry</a></li>
                    <li class="nav-item header-item" role="presentation"><a class="nav-link" id="v-pills-ovens-air-conditioning-tab" data-bs-toggle="pill" data-bs-target="#v-pills-ovens-air-conditioning-type" type="button" role="tab" aria-controls="v-pills-ovens-air-conditioning-type" aria-selected="false" href="product.html">Air conditioning</a></li>
                    <li class="nav-item header-item" role="presentation"><a class="nav-link" href="product.html">Ovens</a></li>
                    <li class="nav-item header-item" role="presentation"><a class="nav-link" href="product.html">Microwaves</a></li>
                    <li class="nav-item header-item" role="presentation"><a class="nav-link" href="product.html">Dishwasher</a></li>
                    <li class="nav-item header-item" role="presentation"><a class="nav-link" href="product.html">Hobs</a></li>
                </ul>
            </nav>
